...
namespace EmployeeManagement.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = EmployeeManagementConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
